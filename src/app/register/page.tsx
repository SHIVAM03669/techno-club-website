  ...
  if (isSubmitted) {
    return (
      <div className="min-h-screen pt-20 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center px-4">
        ...
        >
          <div className="bg-gradient-to-r from-green-500/10 via-blue-500/10 to-purple-500/10 p-12 rounded-2xl border border-green-500/20">
            <motion.div
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
            ...
            <h1 className="font-bold text-3xl md:text-4xl mb-6 bg-gradient-to-r from-green-500 to-blue-500 bg-clip-text text-transparent">
            ...
            <div className="bg-slate-800/50 p-6 rounded-lg border border-blue-500/20">
              <h3 className="font-semibold text-xl text-blue-500 mb-4">What's Next?</h3>
    ...
    <div className="min-h-screen pt-20 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      >
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <span className='text-[#81ff00]'>Join TSC</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                <h2 className="font-bold text-2xl text-green-500 mb-6 flex items-center">
                  <User className="w-6 h-6 mr-3" />
                  <span className='text-[#81ff00]'>Personal Information</span>
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-slate-700 border border-gray-600 rounded-lg focus:outline-none focus:border-green-500 text-white"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-300 mb-2">
              ...
              <div>
                <h2 className="font-bold text-2xl text-blue-500 mb-6 flex items-center">
                  <GraduationCap className="w-6 h-6 mr-3" />
                  <span className='text-[#81ff00]'>Academic Information</span>
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-medium text-gray-300 mb-2">
              ...
              {/* Technical Skills */}
              <div>
                <h2 className="font-bold text-2xl text-purple-500 mb-6 flex items-center">
                  <Code className="w-6 h-6 mr-3" />
                  <span className='text-[#81ff00]'>Technical Skills</span>
                </h2>
                <p className="text-gray-400 mb-4">Select all skills that apply to you:</p>
                    ...
                    <button
                      ...
                      className={`p-3 rounded-lg text-sm font-medium transition-all duration-300 ${
                        formData.skills.includes(skill)
                          ? 'bg-gradient-to-r from-purple-500 to-green-500 text-slate-900'
              ...
              {/* Interests */}
              <div>
                <h2 className="font-bold text-2xl text-yellow-500 mb-6 flex items-center">
                  <Lightbulb className="w-6 h-6 mr-3" />
                  <span className='text-[#81ff00]'>Areas of Interest</span>
                </h2>
                <p className="text-gray-400 mb-4">What sustainability areas interest you most?</p>
                    ...
                    <button
                      ...
                      className={`p-3 rounded-lg text-sm font-medium transition-all duration-300 ${
                        formData.interests.includes(interest)
                          ? 'bg-gradient-to-r from-yellow-500 to-green-500 text-slate-900'
                          : 'bg-slate-700 text-gray-300 hover:bg-slate-600 border border-gray-600'
                      }`}
                    >
                      {interest}
              ...
              <div>
                <h2 className="font-bold text-2xl text-green-500 mb-6 flex items-center">
                  ...
                  <span className='text-[#81ff00]'>Tell Us More</span>
                </h2>
